 ...
 * alone builds and tests green — no monorepo, no credentials and <em>no docker</em> — and this
 * context's store is postgres now. Testcontainers and Quarkus dev services are therefore both out,
 ...
 *
 * <p>The `service` module carries its own copy of this class, because a test class is not a
