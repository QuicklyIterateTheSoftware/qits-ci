 ...
 * qits-events wire shape -- the same reason {@link CiConfigSource} is a port here and a hand-rolled
 * client in {@code service}. <b>Zero implementations is a supported configuration</b>, the same
 * precedent: this port lands before its sole production implementation does ({@code
