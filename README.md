...
Measured 2026-09-04: a commissioned client holding `qits:system` and its own project's claim was 403
here while every other `/ci/api` read answered it, which made the documented manual re-fire mechanism
unusable by exactly the callers that need it.
